...
export default function SignTutorial() {
  ...
  // For real scenario, we would load the prescription and pass its instructions or med data.
  ...
  return (
    <View className="flex-1 bg-background">
      <PageHeader title="لغة الإشارة للوصفة" showBackButton />
      ...
      >
        ...
        <View className="bg-white rounded-[24px] p-4 flex-row items-center gap-4 shadow-sm border border-gray-100 mt-4 mb-6">
          <View className="w-[90px] h-[90px] bg-primary/5 rounded-2xl items-center justify-center overflow-hidden">
            <Pill size={40} color="#0C6B58" />
          </View>
        ...
        <View className="bg-white rounded-[24px] p-5 flex-row items-center justify-between mb-6 shadow-sm border border-gray-100">
           <View className="flex-row items-center gap-4">
              <TouchableOpacity className="items-center gap-1" activeOpacity={0.8}>
      ...
      {/* Footer Button */}
      <View className="absolute bottom-0 left-0 right-0 px-5 pt-4 bg-white border-t border-gray-100" style={{ paddingBottom: bottom > 0 ? bottom : 20 }}>
        <TouchableOpacity 
        ...
        >
           ...
           <Text className="text-white font-bold text-base">حفظ في السجل</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
