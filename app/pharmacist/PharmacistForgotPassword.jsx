      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1, paddingHorizontal: 24, paddingTop: top + 20, paddingBottom: 40 }} showsVerticalScrollIndicator={false}>
        ...
        {!isSubmitted ? (
          <View className="flex-1">
            ...
            <TouchableOpacity className="bg-primary h-14 rounded-xl flex-row items-center justify-center shadow-lg shadow-primary/30 mt-4" onPress={handleSubmit} activeOpacity={0.8}>
          ...
          <View className="flex-1 items-center justify-center py-10">
            ...
            <Text className="text-2xl font-extrabold text-gray-900 mb-3 text-center">تم إرسال الرابط!</Text>
            <Text className="text-base text-gray-500 text-center leading-relaxed px-4 mb-10">لقد أرسلنا تعليمات استعادة كلمة المرور إلى {email}. يرجى التحقق من صندوق الوارد الخاص بك.</Text>
            <TouchableOpacity className="w-full bg-primary h-14 rounded-xl flex-row items-center justify-center shadow-sm" onPress={() => router.replace("/pharmacist/PharmacistLogin")} activeOpacity={0.8}>
